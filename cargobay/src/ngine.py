...
class TestPage(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		self.Tree3 = ttk.Treeview(grid_frame)
		self.Tree3.column("#0", width=0, minwidth=0, stretch=tk.NO)

		self.Tree4 = ttk.Treeview(grid_frame)
		self.Tree4.column("#0", width=0, minwidth=0, stretch=tk.NO)
